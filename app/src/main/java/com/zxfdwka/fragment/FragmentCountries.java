...
import com.zxfdwka.adapter.AdapterCountry;
import com.zxfdwka.asyncTask.LoadCountry;
import com.zxfdwka.bestcountrymusic.R;
import com.zxfdwka.bestcountrymusic.SongByCatActivity;
import com.zxfdwka.interfaces.CountryListener;
...
public class FragmentCountries extends Fragment {
    ...
    private void loadCountries() {
        if (methods.isNetworkAvailable()) {
            LoadCountry loadCountry = new LoadCountry(new CountryListener() {
                @Override
                public void onStart() {
                    if (arrayList.size() == 0) {
                ...
                @Override
                public void onEnd(String success, String verifyStatus, String message, ArrayList<ItemCountry> arrayListCountries, int total_records) {
                    if (getActivity() != null) {
                        if (success.equals("1")) {
            ...
            }, methods.getAPIRequest(Constant.METHOD_COUNTRY, page, "", "", "", "", "", "", "", "","","","","","","","", null));
            loadCountry.execute(String.valueOf(page));
        } else {
            ...
            if (Constant.natveAdType.equals("admob")) {
                ...
                AdLoader adLoader = builder.forUnifiedNativeAd(
                        new UnifiedNativeAd.OnUnifiedNativeAdLoadedListener() {
                            ...
                            public void onUnifiedNativeAdLoaded(UnifiedNativeAd unifiedNativeAd) {
                                ...
                                adapterCountry.addAds(unifiedNativeAd);
                ...
                mNativeAdsManager.setListener(new NativeAdsManager.Listener() {
                    ...
                    public void onAdsLoaded() {
                        adapterCountry.setFBNativeAdManager(mNativeAdsManager);
                    }
    ...
    private void setAdapter() {
        if (!isScroll) {
            ...
            adapterCountry = new AdapterCountry(getActivity(), arrayList);
            rv.setAdapter(adapterCountry);
            setEmpty();
        } else {
            adapterCountry.notifyDataSetChanged();
        }
    ...
    public void setEmpty() {
        if (arrayList.size() > 0) {
            ...
            View myView = null;
            if (errr_msg.equals(getString(R.string.err_no_country_found))) {
    ...
    public void onDestroy() {
        if(adapterCountry != null) {
            adapterCountry.destroyNativeAds();
        }
        super.onDestroy();
    }
}