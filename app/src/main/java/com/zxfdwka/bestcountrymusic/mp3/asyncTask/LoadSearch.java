...
import com.zxfdwka.bestcountrymusic.mp3.interfaces.SearchListener;
    ...
    protected String doInBackground(String... strings) {
        try {
            ...
            for (int i = 0; i < jsonArray_song.length(); i++) {
                ...
                ItemSong itemSong = new ItemSong(id, cid, cname, artist, url, thumb, thumb_small, name, desc, total_rate, avg_rate, views, downloads, lyrics, isFav);
