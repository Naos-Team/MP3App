...
import com.zxfdwka.bestcountrymusic.mp3.utils.MediaButtonIntentReceiver;
import com.zxfdwka.bestcountrymusic.mp3.utils.Methods;
import com.zxfdwka.bestcountrymusic.mp3.utils.StreamDataSource;
...
public class PlayerService extends IntentService implements Player.EventListener {
    ...
    public void onCreate() {
        ...
        dataSourceFactory = new DefaultDataSourceFactory(getApplicationContext(), Util.getUserAgent(getApplicationContext(), "bestcountrymusic"), bandwidthMeter);
    ...
    private void createNoti() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            mMediaSession.setMetadata(new MediaMetadataCompat.Builder()
                    .putString(MediaMetadata.METADATA_KEY_TITLE, Constant.arrayList_play.get(Constant.playPos).getTitle())
                    .build());
        ...
        new AsyncTask<String, String, String>() {
            ...
            protected String doInBackground(String... strings) {
                try {
                    ...
                    JsonUtils.okhttpPost(Constant.SERVER_URL, methods.getAPIRequest(Constant.METHOD_SINGLE_SONG, 0, deviceId, Constant.arrayList_play.get(Constant.playPos).getId(), "", "", "", "", "", "", "", "", "", "", "", Constant.itemUser.getId(), "", null));
