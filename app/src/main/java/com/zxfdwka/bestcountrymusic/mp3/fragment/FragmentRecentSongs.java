...
public class FragmentRecentSongs extends Fragment {
    ...
    private String errr_msg, recentSongIDs = "";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        txt_title_SongByPlaylist.setText(getString(R.string.recently_played));
        iv_playlist2.setImageResource(R.drawable.recent_lastest);
...
//                    collapsing_play.setTitle("Trending Songs");
                    ((MainActivity) getActivity()).getSupportActionBar().setTitle(getString(R.string.recently_played));
