...
import com.naosteam.countrymusic.mp3.fragment.FragmentOFAlbums;
import com.naosteam.countrymusic.mp3.fragment.FragmentOFArtist;
import com.naosteam.countrymusic.mp3.fragment.FragmentOFPlaylist;
import com.naosteam.countrymusic.mp3.fragment.FragmentOFSongs;
...
//        methods.showSMARTBannerAd(ll_adView_player);
...
//            new LoadOfflineSongs().execute();
    ...
    public Boolean checkPer() {
        if (android.os.Build.VERSION.SDK_INT >= 29) {
            if ((ContextCompat.checkSelfPermission(OfflineMusicActivity.this, READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED)) {
            ...
            if ((ContextCompat.checkSelfPermission(OfflineMusicActivity.this, WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED)) {
