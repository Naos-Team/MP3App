    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        methods = new Methods(this, new InterAdListener() {
            ...
            public void onClick(int position, String type) {
                Intent intent = new Intent(FavoriteActivity.this, PlayerService.class);
        ...
        progressBar = findViewById(R.id.pb_latest);
        rv = findViewById(R.id.rv_latest);
...
//                                                Constant.arrayList_play.addAll(arrayListLatest);
    ...
    private void setAdapter() {
        if (!isScroll) {
            adapter = new AdapterAllSongList(this, arrayList, new ClickListenerPlayList() {
                @Override
