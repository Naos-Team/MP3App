...
public class AdapterApps extends RecyclerView.Adapter {

    private Context context;
    private ArrayList<ItemApps> arrayList;
    private ArrayList<ItemApps> filteredArrayList;
    ...
    public AdapterApps(Context context, ArrayList<ItemApps> arrayList) {
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        MyViewHolder(View view) {
            ...
            iv_play = view.findViewById(R.id.iv);
        }
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof MyViewHolder) {
            ...
            ((MyViewHolder) holder).iv_play.setVisibility(View.GONE);
...
//                            CardView cardView = (CardView) ((Activity) context).getLayoutInflater().inflate(R.layout.layout_native_ad_admob, null);
    ...
    public ItemApps getItem(int pos) {
    ...
    public int getRealPos(int pos, ArrayList<ItemAlbums> arrayListTemp) {
    ...
    private class NameFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            if (constraint.toString().length() > 0) {
                ArrayList<ItemApps> filteredItems = new ArrayList<>();
        ...
        protected void publishResults(CharSequence constraint, FilterResults results) {
            ...
            arrayList = (ArrayList<ItemApps>) results.values;
            notifyDataSetChanged();
        }
    }
}