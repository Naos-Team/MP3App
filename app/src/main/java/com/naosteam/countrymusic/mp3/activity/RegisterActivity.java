...
import com.naosteam.countrymusic.mp3.asyncTask.LoadRegister;
import com.naosteam.countrymusic.mp3.interfaces.SocialLoginListener;
...
public class RegisterActivity extends AppCompatActivity {
    ...
    private void loadRegister() {
        if (methods.isNetworkAvailable()) {
            ...
            }, methods.getAPIRequest(Constant.METHOD_REGISTER, 0, "", "", "", Constant.LOGIN_TYPE_NORMAL, "", "", "", "", "", editText_email.getText().toString(), editText_pass.getText().toString(), editText_name.getText().toString(), editText_phone.getText().toString(), "", "", null));
