...
import com.naosteam.countrymusic.radio.adapter.AdapterOnDemandCat;
import com.naosteam.countrymusic.radio.asyncTasks.LoadOnDemandCat;
...
public class FragmentOnDemandCat extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mp3_methods = new com.naosteam.countrymusic.mp3.utils.Methods(getContext(), interAdListener);
...
//        radio_lp_grid.setMargins(0, top, 0, bottom);
    ...
    private com.naosteam.countrymusic.mp3.interfaces.InterAdListener interAdListener = new InterAdListener() {
        @Override
