package com.naosteam.countrymusic.radio.activity;
...
import com.naosteam.countrymusic.radio.fragments.FragmentHome;
import com.naosteam.countrymusic.radio.fragments.FragmentLanguage;
import com.naosteam.countrymusic.radio.fragments.FragmentLanguageDetails;
import com.naosteam.countrymusic.radio.fragments.FragmentMain;
import com.naosteam.countrymusic.radio.fragments.FragmentOnDemandCat;
import com.naosteam.countrymusic.radio.fragments.FragmentOnDemandDetails;
import com.naosteam.countrymusic.radio.fragments.FragmentSearch;
...
public class RadioBaseActivity extends AppCompatActivity {
    ...
    private static final int BACK_PREMIUM = 656;
    Toolbar toolbar;
    ...
    com.naosteam.countrymusic.mp3.utils.Methods mp3_methods;
    //    LoadAbout loadAbout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mp3_methods = new com.naosteam.countrymusic.mp3.utils.Methods(this);
...
//        navigationView.setCheckedItem(navigationView.getMenu().findItem(R.id.nav_home).getItemId());
    ...
    private void clickNav(int item) {
        switch (item) {
            ...
            case R.id.nav_premium:
                ...
                Intent intent = new Intent(RadioBaseActivity.this, PurchaseActivity.class);
                startActivityIfNeeded(intent, BACK_PREMIUM);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (resultCode == RESULT_OK && requestCode == BACK_PREMIUM) {
            if (current_nav == radio_nav) {
                bottomNavigationView.getMenu().getItem(0).setChecked(true);
            } else if (current_nav == demand_nav) {
                bottomNavigationView.getMenu().getItem(1).setChecked(true);
            } else if (current_nav == featured_nav) {
                bottomNavigationView.getMenu().getItem(2).setChecked(true);
            } else if (current_nav == favorite_nav) {
