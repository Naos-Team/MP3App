...
import com.naosteam.countrymusic.radio.adapter.AdapterHomeCity;
import com.naosteam.countrymusic.radio.adapter.AdapterHomeLanguage;
import com.naosteam.countrymusic.radio.adapter.AdapterRadioList;
import com.naosteam.countrymusic.radio.adapter.AdapterSlideOnDemand;
import com.naosteam.countrymusic.radio.asyncTasks.LoadCity;
...
import com.naosteam.countrymusic.radio.interfaces.CityListener;
...
public class FragmentHome extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mp3_methods = new com.naosteam.countrymusic.mp3.utils.Methods(getActivity());
...
//                            recyclerView_featured.setAdapter(adapterRadioList_featured);
    ...
    private void loadSlider() {
        com.naosteam.countrymusic.mp3.interfaces.InterAdListener interAdListener = new InterAdListener() {
            @Override
        ...
        com.naosteam.countrymusic.mp3.utils.Methods mp3_methods = new com.naosteam.countrymusic.mp3.utils.Methods(getActivity(), interAdListener);
